...
\newcommand{\UGThesisSecTitle}
  {\bibsectiontitleformat{Undergraduate Senior Thesis}}
\newcommand{\posterSecTitle}
  {\bibsectiontitleformat{Posters}}

\newcites{ConfPaper,JournalPaper,Workshop,Book,PhD,Poster,UGThesis}{
	\confPaperSecTitle,\journalPaperSecTitle,\workshopSecTitle,\bookSecTitle,\phdSecTitle,\posterSecTitle,\UGThesisSecTitle}
