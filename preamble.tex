...
%\address{}{}    % optional
\phone{302.689.3894}                                   % optional
\email{stephen@herbein.net}                              % optional

\extrainfo{\href{https://herbein.net}{\url{https://herbein.net}}}
...
\newcommand{\github}[2]{\href{https://github.com/#1/#2}{#2}}
...
\newcommand{\journalPaperSecTitle}
  {\bibsectiontitleformat{Journal Papers}}
\newcommand{\confPaperSecTitle}
...
\newcommand{\ThesesSecTitle}
  {\bibsectiontitleformat{Theses}}
\newcommand{\posterSecTitle}
  {\bibsectiontitleformat{Posters}}

\newcites{ConfPaper,JournalPaper,Workshop,Book,PhD,Poster,Theses}{
	\confPaperSecTitle,\journalPaperSecTitle,\workshopSecTitle,\bookSecTitle,\phdSecTitle,\posterSecTitle,\ThesesSecTitle}
